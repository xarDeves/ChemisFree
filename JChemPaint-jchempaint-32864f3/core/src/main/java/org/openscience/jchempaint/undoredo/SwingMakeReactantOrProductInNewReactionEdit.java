 ...
 *
 */
public class SwingMakeReactantOrProductInNewReactionEdit extends MakeReactantOrProductInNewReactionEdit implements UndoableEdit{

	public SwingMakeReactantOrProductInNewReactionEdit(IChemModel chemModel,
			IAtomContainer ac, IAtomContainer oldcontainer, boolean reactantOrProduct, String type) {
		super(chemModel, ac, oldcontainer, reactantOrProduct, type);
	}
