 ...
 *
 */
public class SwingChangeIsotopeEdit extends ChangeIsotopeEdit implements UndoableEdit{

	public SwingChangeIsotopeEdit(IAtom atom, Integer formerIsotopeNumber,
			Integer isotopeNumber, String type) {
		super(atom, formerIsotopeNumber, isotopeNumber, type);
	}
