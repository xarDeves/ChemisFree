 ...
 *
 */
public class SwingReplaceAtomEdit extends ReplaceAtomEdit implements UndoableEdit{

	public SwingReplaceAtomEdit(IChemModel chemModel,
			IAtom oldAtom, IAtom newAtom, String type) {
		super(chemModel, oldAtom, newAtom, type);
	}
