...
import org.openscience.jchempaint.controller.undoredo.ChangeValenceEdit;
 ...
 */
public class SwingChangeValenceEdit extends ChangeValenceEdit implements UndoableEdit {

	public SwingChangeValenceEdit(IAtom atomInRange,
			Integer formerValence, Integer valence, String text,
			IChemModelRelay chemModelRelay) {
		super(atomInRange, formerValence, valence, text, chemModelRelay);
	}
